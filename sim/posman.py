...
class PositionManager:
    ...
    def openPosition(self, t: pd.Timestamp, price: float, note: str = '') -> dict:
        """
        建玉の取得
        :param t: 時刻
        :param price: 株価
    ...
    def closePosition(self, t: pd.Timestamp, price: float, note: str = '') -> float:
        """
        建玉の返却
        :param t:
        :param price:
    ...
    def getColumnFormatOrder(self) -> list:
        """
        注文履歴のデータフレームの列書式
        :return:
        """
